 ...
 *
 * Test driver for the slist (string linked list) module.
 * Builds a list manually and verifies that slist_explode correctly splits a
 * string on a given delimiter.
 */
#include <stdio.h>
